<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Fine.aspx.cs" Inherits="Admin_Default8" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="Server">
    <div class="submenu">
        <ul>
            <li><a href="Settings.aspx" >Category</a></li>
            <li><a href="#" class="selected">Fine</a></li>
