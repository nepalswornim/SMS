<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="SearchBook.aspx.cs" Inherits="Admin_Default13" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="header">
        ...
        <div class="menu">
            <ul>
                <li><a href="#" class="selected">Book</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="Server">
    <div class="submenu">
        <ul>
            ...
            <li><a href="#" class="selected">Search Book</a></li>
