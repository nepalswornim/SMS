<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="IssueBookReport.aspx.cs" Inherits="Admin_Default7" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="Server">
    <div class="submenu">
        <ul>
            ...
            <li><a href="#" class="selected">Issue Book Report</a></li>
             <li><a href="ReturnBookReport.aspx">Return Book Report</a></li>
