<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="User.aspx.cs" Inherits="Admin_Default6" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="Server">
    <div class="submenu">
        <ul>
            <li><a href="#" class="selected">New User</a></li>
            <li><a href="BlockUser.aspx">Block User</a></li>
